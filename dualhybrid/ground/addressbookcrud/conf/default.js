...
module.exports = {
	...
	// API key
	apikey: 'giMbopxrImfNs9Y7Hlv6jwTLDxahoiyJ',
	...
	session: {
		...
		encryptionKey: 'tOycApJmlr0PB67dotqy0PdP3vj/C+6ya/QSnlGCEPs=',
		signatureAlgorithm: 'sha512-drop256',
		signatureKey: 'MC5XU7OG2QhQj2OZnbktJPNStMeYlsXbFmu4CcTH4qVPl0dJcrgouzKFId9azkG/2a/mY0O++vT7hvWI6+RNVw==',
		secret: 'WudTe9JybCoACyVM43I4Laci8e4sS63K', // should be a large unguessable string
	...
	cookieSecret: 'Wv3O+VJTwK8NhSogZr21Zakn2LkHd5al',
