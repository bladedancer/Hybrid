...
echo ======================
k3d i --name=democluster  bladedancer/api-builder-demo-services:news-service
k3d i --name=democluster  bladedancer/api-builder-demo-services:weather-service
k3d i --name=democluster  bladedancer/api-builder-demo-services:user-news-and-weather
