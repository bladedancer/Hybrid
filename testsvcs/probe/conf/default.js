...
module.exports = {
	...
	session: {
		...
		encryptionKey: 'W/9je6Z9WvvxMKFDYrf/kfb8U2bgZSkgd6n+fal2AZw=',
		signatureAlgorithm: 'sha512-drop256',
		signatureKey: 'XoPfYeNRlwRFSYonmSZGoFxRG1oB3EUAv92yRo55GOcmLF1LupUv5xLPYREWcU4bnD0sthdmUtAXrG/Y8QYBCg==',
		secret: 'r2JQSIFgWxJpfyNX+JzAsj9zXspdrpoC', // should be a large unguessable string
	...
	cookieSecret: 'J4LpJgYKs+BrX6kY/BfEO9i1VVcOLmnW',
